...
import { ArrowRight, BookOpen, Brain, Calendar, Shield } from "lucide-react";
    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-md border-b border-border">
        <div className="container mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 font-bold text-xl text-primary">
            ...
            <span className="hidden md:inline">Student Planner</span>
            <span className="md:hidden">Planner</span>
          </div>

          {/* Buttons - FIXED FOR MOBILE with asChild */}
      ...
      <footer className="py-10 border-t border-border">
        <div className="container mx-auto px-6 text-center text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} Student Planner. Built for success.</p>
        </div>
      </footer>
    </div>
  );
